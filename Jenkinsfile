    ...
    stages {
        stage("build & SonarQube analysis") {
            ...
            steps {
              withSonarQubeEnv('sonar') {
                slackSend channel: '#devops-casestudy-group7', message: 'slackSend (color: '#FFFF00', message: "STARTED: Job '${env.JOB_NAME} [${env.BUILD_NUMBER}]' (${env.BUILD_URL})")', teamDomain: 'devops-casestudy', tokenCredentialId: 'slack-key'
        ...
        stage('Perfomance Testing') {
            steps {
                ...
                blazeMeterTest credentialsId: 'Blazemeter-Updated', testId: '7912822.taurus', workspaceId: '475895'
